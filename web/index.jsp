...
<head>
    ...
    <style>
        ...
        .btn.green {
            border: 4px solid var(--blue_corn);
            color: var(--blue);
        }
        ...
        @media (prefers-color-scheme: dark) {
            body {background:  #4F726C; color: white;}
        }
...
<nav data-state="closed">
    <ul>
        <li><a href="https://mapotofu.cn">俺的主页</a></li>
        <li><a href="https://blog.treeoncloud.com">俺的博客</a></li>
    </ul>
</nav>
        ...
        <div class="row">
            <div class="col-md-6 align-self-center">
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
                        ...
                        <g id="planet" transform="matrix(1,-0.0049,0.0049,1,-0.5331,2.783)" style="transform-origin: 0px 0px;">
                            <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788"></circle>

                            <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891" cy="62.319" r="13.074" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0.419,0)"></circle>

                            <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743" cy="158.918" r="7.989" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,-0.419,0)"></circle>
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"></path>
                        ...
                        <g id="stars">
                            <g id="starsBig">
                                <g transform="matrix(0.9974,0.0723,-0.0723,0.9974,19.8542,-36.7909)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.9991,-0.0424,0.0424,0.9991,-10.1215,6.7707)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.9909,-0.1347,0.1347,0.9909,-16.3959,44.4266)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.9936,-0.1133,0.1133,0.9936,-54.6534,25.8957)" style="transform-origin: 0px 0px;">
                            ...
                            <g id="starsSmall">
                                <g transform="matrix(0.737,0,0,0.7379,113.6614,101.2165)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.493,0,0,0.4931,248.2041,154.0695)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.168,0,0,0.1683,192.5818,245.5087)" style="transform-origin: 0px 0px;">
                            ...
                            <g id="circlesBig">
                                ...
                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="588.977" cy="255.978" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="450.066" cy="320.259" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="168.303" cy="353.753" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="200.67" cy="176.313" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="133.343" cy="477.014" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="283.521" cy="568.033" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="413.618" cy="482.387" r="7.952" transform="matrix(1,0,0,1,0,-0.279)" style="transform-origin: 0px 0px;"></circle>
                            </g>
                            <g id="circlesSmall">
                                <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651" transform="matrix(1,0,0,1,0,-0.559)" style="transform-origin: 0px 0px;"></circle>
                            </g>
                        </g>
                        <g id="spaceman" clip-path="url(cordClip)" style="transform-origin: 0px 0px;" transform="matrix(1,0.0024,-0.0024,1,0.5304,0.1945)">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
				...
				M269.678,394.912L269.678,394.912c26.3,20.643,59.654,29.585,93.106,25.724l2.419-0.114"></path>
					...
					C278.993,441.286,286.836,447.55,296.315,452.273z"></path>
                            ...
                            <g id="head">
                                ...
                                <ellipse transform="matrix(0.259 -0.9659 0.9659 0.259 -51.5445 563.2371)" fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="341.295" cy="315.211" rx="61.961"
                                         ry="60.305"></ellipse>
				...
				M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246" style="transform-origin: 0px 0px;" transform="matrix(1,0.0024,-0.0024,1,0.6272,-0.6728)"></path>
